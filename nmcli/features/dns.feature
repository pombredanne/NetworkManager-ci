...
##########################################
    ...
    @rhbz1512966
    @ver+=1.11.3
    @con_dns_remove @dns_systemd_resolved @not_in_rhel7 @not_in_rhel8
    ...
    * Bring "up" connection "con_dns2"
    ...
    @rhbz1512966
    @ver+=1.11.3
    @con_dns_remove @eth0 @dns_systemd_resolved @not_in_rhel7 @not_in_rhel8
    ...
    * Bring "up" connection "con_dns2"
    ...
    @rhbz1512966
    @ver+=1.11.3
    @con_dns_remove @openvpn @openvpn4 @dns_systemd_resolved @not_in_rhel7 @not_in_rhel8
